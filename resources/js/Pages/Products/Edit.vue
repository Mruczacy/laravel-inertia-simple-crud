    ...
    <AppLayout title="Stwórz produkt">
        ...
        <form @submit.prevent="updateProduct(product)">
            <div class="flex flex-wrap -mb-8 -mr-6 p-8">
                <text-input v-model="product.name" :error="form.errors.name" class="pb-8 pr-6 w-full lg:w-1/2" label="Name" />
                <text-input v-model="product.base_price" :error="form.errors.base_price" class="pb-8 pr-6 w-full lg:w-1/2" label="Base Price" />
                <text-input v-model="product.discount_price" :error="form.errors.discount_price" class="pb-8 pr-6 w-full lg:w-1/2" label="Discount Price" />
                <text-input v-model="product.description" :error="form.errors.description" class="pb-8 pr-6 w-full lg:w-1/2" label="Description" />
            </div>
